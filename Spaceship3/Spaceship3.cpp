...
void ShipBody()
{
    ...
    gluCylinder(pObj, 1, 1, 3, 26, 26);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(0.5,1,5);
    glScalef(1,1,3);
    gluSphere(pObj, 1, 26, 26);
    glPopMatrix();
    ...
    glVertex3f(3,1.5,13);
    glVertex3f(1.5,2.5,7);
    glVertex3f(2.3,2.5,13);
    glVertex3f(0.5,2.5,7);
    glVertex3f(0.5,2.5,13);
    glVertex3f(0,2.5,7);
    glVertex3f(0,2.5,13);
    glVertex3f(-0.5,2.5,7);
    glVertex3f(-1.3,2.5,13);
...
{
    glPushMatrix();
    glTranslatef(1.5,0.6,12);
    glScalef(0.5,0.5,0.3);
    Thruster();
    glPopMatrix();

    glPushMatrix();
    glTranslatef(-0.5,0.6,12);
    glScalef(0.5,0.5,0.3);
    Thruster();
    glPopMatrix();
}
